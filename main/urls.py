...
from main.views import show_main, create_product, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user, plus_product_amount, minus_product_amount, remove_product, edit_product, delete_product, get_product_json, add_product_ajax, delete_product_ajax
